...
if (!file.exists(paste0("C:/Users/OZAN/Desktop/biochallange", my_gtf))){
  download.file(url = my_url, destfile = paste0("C:/Users/OZAN/Desktop/biochallange", my_gtf))
}
...
gtf <- read.table("C:/Users/OZAN/Desktop/biochallange/my_gtf", sep="\t", header=FALSE)

# Remove rows containing NAs
gtf <- gtf[complete.cases(gtf),]


my_obj <- import(paste0("C:/Users/OZAN/Desktop/biochallange", my_gtf))
...
my_txdb <- makeTxDbFromGFF(paste0("C:/Users/OZAN/Desktop/biochallange", my_gtf))
